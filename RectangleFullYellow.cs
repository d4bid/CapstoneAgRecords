...
namespace AgRecords
{
    public partial class RectangleFullYellow : UserControl
    {
        public RectangleFullYellow()
        {
            InitializeComponent();
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (GraphicsPath path = new GraphicsPath())
            {
                ...
                using (SolidBrush backgroundBrush = new SolidBrush(Color.FromArgb(255, 221, 100)))
                {
